...
class PostgresChatMessageHistory(BaseChatMessageHistory):
    def __init__(
        ...
        /,
        *,
        sync_connection: Optional[psycopg2.Connection] = None,
        async_connection: Optional[psycopg2.AsyncConnection] = None,
    ) -> None:
        """Client for persisting chat message history in a Postgres database,
    ...
    @staticmethod
    def drop_table(connection: psycopg2.Connection, table_name: str, /) -> None:
